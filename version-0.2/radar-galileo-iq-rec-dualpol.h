// From original include file for radar-galileo-iq-rec-dualpol.c
...
// #define CAL_FILE "/mnt/focus_radar_data/radar-galileo/etc/radar-galileo.cal"
// #define CONFIG_FILE "/mnt/focus_radar_data/radar-galileo/etc/radar-galileo-iq-dualpol.conf"
...
#define SWAP_CHAN_IH 2
#define SWAP_CHAN_QH 3
#define SWAP_CHAN_IV 0
#define SWAP_CHAN_QV 1
...
#define CONFIG_FILE RADAR_DATA_PATH "radar-galileo/etc/radar-galileo-iq-dualpol.conf"
